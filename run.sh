...
python steerability.py --pres repeat_present.txt --past repeat_past.txt --walk_file walk_repeat_zero_init.pt --init_mode zero > results_05_11_21/walk_repeat_zero_init.log
